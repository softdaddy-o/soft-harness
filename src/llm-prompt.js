...
function buildPrompt(options) {
    ...
    return [
        'You are helping resolve soft-harness plugin origins.',
        '',
        'Goal:',
        '- Complete the full plugin-origin workflow yourself.',
        '- Inspect my current LLM plugin inventory.',
        '- Find GitHub repositories and official marketplace pages for installed plugins.',
        ...
        '- It is safe before first sync: `plugins import-origins` can create `.harness/plugin-origins.yaml` by itself.',
        ...
        '',
        '5. Save the found origins into soft-harness:',
        '```bash',
