...
function buildPrompt(options) {
    ...
    return [
        ...
        '- It is safe before the first snapshot refresh: origin import commands can create `.harness/plugin-origins.yaml` and `.harness/asset-origins.yaml` by themselves.',
        '- Do not use legacy `soft-harness sync` as part of this workflow.',
